...
\addplot[color=black, mark=none, thick] table[x=month, y=rmrf_ru_fixed, col sep=comma]{data/ru_factors_cumulative_growth_data.csv};
...
\addplot[color=black, mark=none, thick] table[x=month, y=rmrf_ru_fixed, col sep=comma]{data/ru_factors_cumulative_growth_data_2015.csv};
