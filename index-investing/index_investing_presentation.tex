...
\justify
Две акции $X$ и $Y$ имеют одинаковые ожидаемые доходности и стандартные отклонения: $\mu = 5\%$ и $\sigma = 10\%$. Корреляция доходностей $\rho=0.4$. Инвестор может вложить долю $\alpha$ своего богатства в $X$ и долю $(1 - \alpha)$ в $Y$.

\vspace{\baselineskip}
Ожидаемая доходность не зависит от $\alpha$:
\begin{align*}
\mathbb{E}(\alpha X + (1 - \alpha)Y) &= \alpha\mathbb{E}X + (1-\alpha)\mathbb{E}Y \\ &= \alpha\mu + (1 - \alpha)\mu = \mu = 5\%
\end{align*}

Может ли выбор $\alpha$ уменьшить стандартное отклонение, т.е. риск?
\end{frame}
...
\begin{axis}[
  width = \textwidth * 0.7,
  xlabel={$\alpha$ --- доля инвестиций в акцию $X$},
...
\renewcommand{\drawPortfolioNode}[8]{\node[anchor=#8] at (axis cs: #1, #2) {
	...
	\node[circle, fill, inner sep=2pt, color=blue] at (axis cs:#1, #2) {};
}
...
\addplot[line width=1pt, color=blue, domain=0:21] {4 + x * (6.75 - 4) / 4.83};

\drawPortfolioNodeTwo{1.45}{4.83}{Портфель А}{30}{70}{north west}

\drawPortfolioNodeTwo{7.25}{8.12}{Портфель B}{200}{-100}{north west}

\drawAssetNode{0.0}{4.0}{F}{north west}

\drawPortfolioNode{4.83}{6.75}{Портфель T}{24.2}{69.5}{1.5}{4.8}{south east}

\addplot[line width=1pt, color=blue, dashed] table[x=std_dev, y=target_return, col sep=comma] {data/efficient_frontier_plot_data.csv};
...
\vspace{\baselineskip}
Вывод: портфель $T$ --- это весь рынок рискованных активов (market portfolio)!
\end{frame}
...
\begin{axis}[
  ...
  xtick={1940-01-01,1960-01-01,1980-01-01,2000-01-01,2020-01-01},
  ...
  ylabel={\small{Рост \$1 сверх безрисковой ставки}},
  xlabel near ticks,
  ylabel near ticks
]
\addplot[color=blue, mark=none, thick] table[x=date, y=mkt_rf, col sep=comma]{data/fama_french_cumulative_growth_data.csv};

\draw[red] (axis cs: 1929-08-31, 2.27) -- (axis cs: 1945-02-28, 2.27) node[pos=0.5,anchor=south]{\scriptsize{1929-45}};
\draw[red] (axis cs: 1968-11-30, 28.28) -- (axis cs: 1983-04-30, 28.28) node[pos=0.5,anchor=south]{\scriptsize{1968-83}};
\draw[red] (axis cs: 2000-03-31, 148.33) -- (axis cs: 2013-01-31, 148.33) node[pos=0.5,anchor=south]{\scriptsize{2000-13}};

\draw[red] (axis cs: 1929-08-31, 2.27) -- (axis cs: 1932-06-30, 0.348) node[anchor=west]{\scriptsize{-85\%}};
\draw[red] (axis cs: 1968-11-30, 28.28) -- (axis cs: 1974-09-30, 12.5) node[anchor=west]{\scriptsize{-56\%}};
\draw[red] (axis cs: 2000-03-31, 148.33) -- (axis cs: 2009-02-28, 67.7) node[anchor=west]{\scriptsize{-54\%}};
\end{axis}
\end{tikzpicture}
...
Период & Сред.\,{\scriptsize (ст.\,откл.)} & $t$-тест & $p$-знач. & 99\%\,дов.\,инт. \\
\hline
1927--1959 & 11.2\% {\scriptsize (24.9\%)} & 2.61 & 1.3\%  & [2.5\%, 20.1\%] \\
1960--1989 & 5.2\%  {\scriptsize (16.9\%)} & 1.69 & 10.3\% & [-1.1\%, 11.5\%] \\
1990--2020 & 9.0\%  {\scriptsize (17.7\%)} & 2.81 & 0.9\%  & [2.5\%, 15.5\%] \\
1960--2020 & 7.1\%  {\scriptsize (17.3\%)} & 3.21 & 0.2\%  & [2.7\%, 11.5\%] \\ \hline
1927--2020 & 8.6\%  {\scriptsize (20.2\%)} & 4.11 & <0.1\% & [4.4\%, 12.7\%] \\
\end{tabular}
...
\begin{groupplot}[
    ...
    \addplot[bar width=1pt, fill, color=blue] table[x=mkt_1y_rank, y=sample_mkt_1y, col sep=comma] {data/simulated_market_annual_returns.csv};
    
    \nextgroupplot[title = {Актив B}, ylabel={}]
    \addplot[bar width=1pt, fill, color=blue] table[x=rf_1y_rank, y=sample_rf_1y, col sep=comma] {data/simulated_market_annual_returns.csv};
...
\begin{groupplot}[
    ...
    \addplot[bar width=1pt, fill, color=blue] table[x=mkt_15y_rank, y=sample_mkt_15y, col sep=comma] {data/simulated_market_annual_returns.csv};
    
    \nextgroupplot[title = {Актив D}, ylabel={}]
    \addplot[bar width=1pt, fill, color=blue] table[x=rf_15y_rank, y=sample_rf_15y, col sep=comma] {data/simulated_market_annual_returns.csv};
...
\multirow{2}{*}{Период} & Арифм.\,сред. & Геом. & Отнош. & Отнош. \\
& {\scriptsize (ст.\,откл.)} & сред. & Шарпа & Сортино \\ 
\hline
1927--1959 & 11.2\% {\scriptsize (24.9\%)} & 8.3\% & 0.45 & 1.00 \\
1960--1989 & 5.2\%  {\scriptsize (16.9\%)} & 3.8\% & 0.31 & 0.58 \\
1990--2020 & 9.0\%  {\scriptsize (17.7\%)} & 7.4\% & 0.51 & 1.02 \\
1960--2020 & 7.1\%  {\scriptsize (17.3\%)} & 5.6\% & 0.41 & 0.80 \\ \hline
1927--2020 & 8.6\%  {\scriptsize (20.2\%)} & 6.5\% & 0.42 & 0.88 \\
\end{tabular}
...
\addplot[color=blue, mark=none, thick] table[x=date, y=smb, col sep=comma]{data/fama_french_cumulative_growth_data.csv};
\addplot[color=red, mark=none, thick] table[x=date, y=hml, col sep=comma]{data/fama_french_cumulative_growth_data.csv};
\addplot[color=orange, mark=none, thick] table[x=date, y=mom, col sep=comma]{data/fama_french_cumulative_growth_data.csv};
...
Фактор & Период & Сред.\,{\scriptsize (cт.\,откл.)} & $t$ & $p$ & 99\%\,дов.\,инт.\\ \hline
SMB & 1927--59 & 3.4\% {\scriptsize (13.6\%)}  & 1.41 & 16.7\% & [-1.5\%, 8.2\%] \\
    & 1960--89 & 3.3\% {\scriptsize (13.9\%)}  & 1.29 & 20.9\% & [-1.9\%, 8.4\%] \\
    & 1990--20 & 0.8\% {\scriptsize (9.2\%)}   & 0.49 & 62.7\% & [-2.6\%, 4.2\%] \\
    & 1960--20 & 2.0\% {\scriptsize (11.7\%)}  & 1.34 & 18.4\% & [-1.0\%, 5.0\%] \\
    & 1927--20 & 2.5\% {\scriptsize (12.4\%)}  & 1.95 & 5.4\%  & [-0.0\%, 5.0\%] \\
\hline
HML & 1927--59 & 5.1\% {\scriptsize (14.1\%)}  & 2.07 & 4.7\%  & [0.1\%, 10.0\%] \\
    & 1960--89 & 6.1\% {\scriptsize (11.1\%)}  & 3.03 & 0.5\%  & [2.0\%, 10.3\%] \\
    & 1990--20 & 1.2\% {\scriptsize (15.3\%)}  & 0.42 & 67.7\% & [-4.5\%, 6.8\%] \\
    & 1960--20 & 3.6\% {\scriptsize (13.5\%)}  & 2.08 & 4.1\%  & [0.1\%, 7.1\%] \\
    & 1927--20 & 4.1\% {\scriptsize (13.7\%)}  & 2.92 & 0.4\%  & [1.3\%, 6.9\%] \\
\hline
MOM & 1927--59 & 7.4\% {\scriptsize (17.8\%)}  & 2.40 & 2.3\%  & [1.1\%, 13.7\%] \\
    & 1960--89 & 10.5\% {\scriptsize (12.8\%)} & 4.49 & 0.0\%  & [5.7\%, 15.2\%] \\
    & 1990--20 & 6.6\% {\scriptsize (16.4\%)}  & 2.24 & 3.3\%  & [0.6\%, 12.6\%] \\
    & 1960--20 & 8.5\% {\scriptsize (14.7\%)}  & 4.50 & <0.1\%  & [4.7\%, 12.3\%] \\
    & 1927--20 & 8.1\% {\scriptsize (15.8\%)}  & 4.98 & <0.1\%  & [4.9\%, 11.4\%] \\
\hline
\end{tabular}
...
\centering
\begin{tabular}{l|r|r|r|c}
Фактор & Сред.\,{\scriptsize (ст.\,откл.)} & $t$ & $p$ & 99\%\,дов.\,инт. \\
\hline
MKT-RF & 0.93\% {\scriptsize (6.6\%)} & 1.90 & 5.9\% & [-0.0\%, 1.9\%] \\
SMB    & 1.30\% {\scriptsize (4.9\%)} & 3.58 & <0.1\% & [0.6\%, 2.0\%] \\
HML    & 0.53\% {\scriptsize (6.8\%)} & 1.05 & 29.4\% & [-0.5\%, 1.5\%] \\
LIQ    & 0.06\% {\scriptsize (4.4\%)} & 0.20 & 84.5\% & [-0.6\%, 0.7\%] \\
DP     & 0.07\% {\scriptsize (5.7\%)} & 0.16 & 87.3\% & [-0.8\%, 0.9\%] \\
SOE    & 0.58\% {\scriptsize (3.6\%)} & 2.00 & 4.8\% & [0.0\%, 1.1\%] \\ \hline
\end{tabular}

{\scriptsize Месячные доходности 01.2005--04.2020. SOE: 01.2007--12.2019.}

{\scriptsize Данные: ИПЭИ РАНХиГС.}

\justify
Статистически значимый фактор --- размер (SMB). С натяжкой --- весь рынок (MKT-RF) и частные компании против государственных (SOE). Стоимость (HML), дивидендная доходность (DP) и неликвидность (LIQ), похоже, не дают статистически значимой дополнительной доходности.
\end{frame}
