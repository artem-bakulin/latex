...
\begin{axis}[
    ...
    %legend cell align={left}
        ...
        \dotWithNumber{2022-04-01}{36.3}{Set1-B}{\small 36.3}{east}
...
\begin{axis}[
    ...
    legend cell align={left}
        ...
        \dotWithNumber{2022-03-01}{2.13}{Set1-A}{\small 2.13}{south west}

        \dotWithNumber{2022-03-01}{-0.72}{Set1-B}{\small $-0.72$}{south west}
...
\begin{axis}[
    ...
    \plotShillerData{long_rate}{Set1-A}{none}{2022-04-01}{0.0238}{\small 2.38}{south west}
    \plotShillerData{real_rate_10y}{Set1-B}{none}{2022-04-01}{0.0019}{\small 0.19}{south west}
...
\begin{axis}[
    ...
    %legend cell align={left}
        ...
        \dotWithNumber{2022-04-01}{0.0256}{Set1-B}{\small 2.6}{west}
...
\justify
Лектор составил портфель акций на Московской бирже в ноябре 2015 г. За 6.5 лет до марта 
2022 г. он заработал 202\%. Три паевых фонда, красный, жёлтый и зелёный, заработали 
99\%, 76\% и 68\%. Молодцы ли лектор и управляющие фондами?

\justify
Безрисковая процентная ставка (ключевая ставка ЦБ) за тот же период дала бы 
$66\%$. Индекс ММВБ полной доходности (включая дивиденды минус налоги) вырос на 
$117\%$.
...
\begin{axis}[
  ...
  xtick={2016-01-01,2017-01-01,2018-01-01,2019-01-01,2020-01-01, 2021-01-01, 2022-02-01},
  xticklabel=\year,
  xmin=2015-10-31,
  xmax=2022-06-01,
  grid=major,
...
\addplot[color=Set1-A, only marks, mark=square] table[x=benchmark_excess_return, y=red_excess_return, col sep=comma]{data/fund_excess_return.csv};

\addplot[color=Set1-B, thick, domain=-12:12] {0.57 + 0.63*x};

\addplot[color=Set1-A, thick, domain=-12:12] {-0.09 + 1.033*x};

\draw[thick, black] (-100, 0) -- (100, 0);
\draw[thick, black] (0, -100) -- (0, 100);
...
\begin{axis}[
  ...
  xtick={2005-01-01,2008-01-01,2011-01-01,2014-01-01,2017-01-01,2020-01-01,2023-01-01},
  xticklabel=\year,
  xmin=2005-01-01,
  xmax=2023-01-01,
  ymode=log,
...
\begin{axis}[
  ...
  date coordinates in=x,
  date ZERO=2004-12-31,
  xtick={2015-01-01,2016-01-01,2017-01-01,2018-01-01,2019-01-01,2020-01-01,2021-01-01,2022-01-01,2023-01-01},
  xticklabel=\year,
  xmin=2015-01-01,
  xmax=2023-01-01,
  %ymode=log,
