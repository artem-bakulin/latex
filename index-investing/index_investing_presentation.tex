...
\item Бухгалтерский капитал к рыночной капитализации (\en{book\,value / 
market\,value, B/M}).
\end{itemize}
...
\begin{itemize}
\justifying
\item Компании с высоким B/M --- скучные компании <<стоимости>>. Например,
поставщики коммунальных услуг с многочисленными физическими активами на балансе
(высокое значение \en{book value}).
\item Компании с низким B/M --- гламурные компании <<роста>>. Например,
