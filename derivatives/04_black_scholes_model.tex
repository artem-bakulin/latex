...
\begin{axis}[
  ...
  legend style={at={(0.97,0.03)},anchor=south east}
	...
	\plotDeterministicMotion{gbm_sample_100.csv}{Set1-A}
	\plotDeterministicMotion{gbm_sample_500.csv}{Set1-B}
\end{axis}
\end{tikzpicture}
\end{frame}
...
\begin{axis}[
  ...
  xtick={2012-01-01, 2014-01-01, 2016-01-01, 2018-01-01, 2020-01-01, 2022-01-01, 2024-01-01, 2026-01-01},
  minor xtick={2013-01-01, 2015-01-01, 2017-01-01, 2019-01-01, 2021-01-01, 2023-01-01, 2025-01-01,2027-01-01},
  ytick={30, 40, ..., 120},
...
\justify
Опционы на USDRUB с датой исполнения 18.06.2026.
...
\only<2>{
	...
	\node[anchor=south west] at (90, 1.22) {$C(90)=1.22$};
}
\end{axis}
\end{tikzpicture}
...
\begin{axis}[
	...
	\node[anchor=north west] at (90, 0.1999) {$\sigma(90)=20.0\%$};
\end{axis}
\end{tikzpicture}
...
\justify
Опционы на S\&P\,500 с датой исполнения 18.06.2026.
...
\newcommand{\drawCallNode}[4] {
	...
	\node[anchor=#3] at (#1, #2) {$C(#1)=#2$};
}

\begin{frame}{Опционные бабочки: USDRUB}
\justify
Опционы на USDRUB с датой исполнения 18.06.2026.
...
\begin{axis}[
	...
	\drawCallNode{79}{5.851}{north east};
	\drawCallNode{80}{5.142}{north east};
	\drawCallNode{81}{4.488}{north east};

	\node[anchor=south west] at (80, 5.142) {\begin{tabular}{l}$Fly(80) =$\\ $5.851 - 2 \cdot 5.142 + 4.488$\\$= 0.055$\end{tabular}};
\end{axis}
\end{tikzpicture}
...
\begin{frame}{Опционные бабочки: USDRUB - 2}
\justify
Бабочки со страйками $K-1$, $K$ и $K+1$. Экспирация  18.06.2026.
...
\begin{frame}{<<Ожидаемое>> распределение: USDRUB}
\centering
\begin{tikzpicture}
\begin{axis}[
			width = \textwidth,
...
\begin{frame}{Опционные бабочки: S\&P\,500}
\justify
Бабочки из опционов на S\&P\,500 со страйками $K-50$, $K$, $K+50$.
...
\begin{axis}[
			...
			height = \textheight - 2cm,
			xtick distance=500,
			ytick distance=0.0001,
			xmin=5000, xmax=8000,
			ymin=0, ymax=0.001,
			scaled y ticks = false,
			yticklabel={\pgfmathparse{\tick*100}\pgfmathprintnumber[fixed, precision=2]{\pgfmathresult}},
			xticklabel={\pgfmathprintnumber[precision=0, 1000 sep={}]{\tick}},
			grid = major,
			xlabel={Страйк ($K$)},
...
\justify
1. Участники рынка верно оценивают истинную вероятность экстремальных исходов (больших изменений цены базового актива).
...
\justify
До 2025 года у индекса \en{VIX}\ был брат-близнец \en{RVOL}, который измерял реализованную волатильность индекса \en{S\&P\,500}. Теперь этот индекс приходится считать руками.
\end{frame}
...
\begin{axis}[
  ...
  minor xtick={2003-01-01, 2004-01-01, 2006-01-01, 2007-01-01, 2008-01-01, 2009-01-01, 2011-01-01, 2012-01-01, 2013-01-01, 2014-01-01, 2016-01-01, 2017-01-01, 2018-01-01, 2019-01-01, 2021-01-01, 2022-01-01, 2023-01-01, 2024-01-01,2026-01-01},
  ytick={10, 20, ..., 100},
%  minor ytick={-0.75, -0.25, 0.25, 0.75, 1.25},
  xticklabel={\year},
  xmin=2002-01-01,
...
\end{axis}
\end{tikzpicture}
\small Данные: \en{CBOE, Yahoo Finance}
\end{frame}
