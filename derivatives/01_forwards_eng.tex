...
\justify
\alert{Foreign exchange forward, or outright forward} is a contract, in which two parties commit to exchanging pre-determined amounts in two currencies on a pre-determined future date in at a pre-determined rate. 
