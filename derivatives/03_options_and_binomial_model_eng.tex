...
\begin{tikzpicture}
		...
		\circlewithtext{8.5}{0}{\begin{tabular}{c}Settlement \\ $+1\,000$ EUR\\ $-1\,080$ USD\end{tabular}};
	\end{tikzpicture}
...
\justifying
Owning a EURUSD call option to buy 100 EUR at strike 1.08.
...
\centering
  ...
  \addplot[Set1-A, very thick] {100*(\x > 1.08)*(\x - 1.08) + 0.05};
...
\justifying
Buying 100 EURUSD call options: strike 1.08, premium 2 USD.
...
\justifying
Buying 100 EURUSD put options: strike 1.08, premium 2 USD.
...
\justify
1. In the money, ITM --- current spot price of the underlying asset is higher than the strike (it would be profitable to exercise the option immediately).

\justify
2. At the money, ATM --- current spot price is equal to the strike.

\justify
3. Out of the money, OTM --- current spot price of the underlying asset is lower than the strike (it would be unprofitable to exercise the option immediately).
...
\centering
  ...
  \addplot[Set1-A, very thick, dashed] {-100*(\x < 1.06)*(1.06 - \x) + 0.5};
  \addplot[Set1-B, very thick, dashed] {100*(\x > 1.10)*(\x - 1.10) - 0.5};
  \addplot[Set1-C, very thick] {-100*(\x < 1.06)*(1.06 - \x) + 0.5 + 100*(\x > 1.10)*(\x - 1.10) - 0.5 + 0.05};	

  \draw[thick, color=black] (axis cs: 0, 0) -- (axis cs: 1.14, 0);
\end{axis}
\end{tikzpicture}
\end{frame}
...
\centering
	\begin{tikzpicture}
	  ...
	  \addplot[Set1-A, very thick, dashed] {100*(\x > 1.06)*(\x - 1.06) - 1};
  \addplot[Set1-B, very thick, dashed] {-100*(\x > 1.10)*(\x - 1.10) + 0.5};
  \addplot[Set1-C, very thick] {100*(\x > 1.06)*(\x - 1.06) - 1 - 100*(\x > 1.10)*(\x - 1.10) + 0.5};
...
\centering
	\begin{tikzpicture}
	  ...
	  \addplot[Set1-A, very thick, dashed] {100*(\x < 1.08)*(1.08 - \x) - 1};
  \addplot[Set1-B, very thick, dashed] {100*(\x > 1.08)*(\x - 1.08) - 1};
  \addplot[Set1-C, very thick] {100*(\x < 1.08)*(1.08- \x) - 1 + 100*(\x > 1.08)*(\x - 1.08) - 1};
...
\centering
	...
	\addplot[Set1-A, very thick, dashed] {100*(\x > 1.08)*(\x - 1.08) + 0.1};
  	\addplot[Set1-B, very thick, dashed] {-100*(\x < 1.08)*(1.08-\x) - 0.1};
  	\addplot[Set1-C, very thick] {100*(\x > 1.08)*(\x - 1.08) - 100*(\x < 1.08)*(1.08-\x) };
...
\justifying
100 EUR on bank account and debt of 108 USD
...
\centering
	\begin{tikzpicture}
  	...
  	\addplot[Set1-C, very thick] {100*(\x - 1.08)};
...
\centering
	...
	\addplot[Set1-A, very thick, domain=1.08:1.14] {1};
	\addplot[Set1-A, very thick, domain=1.02:1.08] {0.02};
...
\begin{tikzpicture}
	...
	\addplot[Set1-A, very thick, domain=1.00:1.08] {1};
	\addplot[Set1-A, very thick, domain=1.08:1.14] {0.02};
...
\justifying
\only<1>{Call spread: buy 100 calls-1.075, sell 100 calls-1.085}
\only<2>{Call spread: buy 200 calls-1.0775, sell 200 calls-1.0825}
\only<3>{Call spread: buy 1000 calls-1.0795, sell 1000 calls-1.0805}
...
\only<1>{
	\addplot[Set1-A, very thick, dashed] {100*(\x > 1.075)*(\x - 1.075) - 0.03};
  	\addplot[Set1-B, very thick, dashed] {-100*(\x > 1.085)*(\x - 1.085) + 0.06};
  	\addplot[Set1-C, very thick] {100*(\x > 1.075)*(\x - 1.075) - 100*(\x > 1.085)*(\x - 1.085) + 0.03};
}
\only<2>{
	\addplot[Set1-A, very thick, dashed, samples=100] {200*(\x > 1.0775)*(\x - 1.0775) - 0.03};
  	\addplot[Set1-B, very thick, dashed, samples=100] {-200*(\x > 1.0825)*(\x - 1.0825) + 0.06};
  	\addplot[Set1-C, very thick, samples=100] {200*(\x > 1.0775)*(\x - 1.0775) - 200*(\x > 1.0825)*(\x - 1.0825) + 0.03};
}
\only<3>{
	\addplot[Set1-A, very thick, dashed, samples=100] {1000*(\x > 1.0795)*(\x - 1.0795) - 0.03};
  	\addplot[Set1-B, very thick, dashed, samples=100] {-1000*(\x > 1.0805)*(\x - 1.0805) + 0.06};
  	\addplot[Set1-C, very thick, samples=100] {1000*(\x > 1.0795)*(\x - 1.0795) - 1000*(\x > 1.0805)*(\x - 1.0805) + 0.03};
}
...
\end{align*}
Here $C(K)$ is price of a European vanilla call at strike $K$, $D(K)$ is price of a digital call, $n$ is the number of vanilla calls in the call spread, $\varepsilon=1/2n$.
...
\justify
1. The call pays 1 unit of a currency in case the price of the underlying asset is $\ge K$ (*).

\justify
2. The put pays 1 unit of a currency in case the price of the underlying asset is $< K$.
...
\centering
  ...
  \addplot[Set1-A, very thick,domain=1:1.1199, samples=100] {100*(\x > 1.08)*(\x - 1.08) + 0.03};
  \addplot[Set1-A, very thick,domain=1.12:1.16] {0.03};
...
\justify
How do we replicate a European knock-out option at the strike of 1.08 with the barrier at 1.12?
\end{frame}
...
\justify
Buy 100 vanilla calls-1.08
\only<2->{, sell 100 vanilla calls-1.12}
\only<3->{, sell 4 digital calls-1.12}
\justify
\centering
	\begin{tikzpicture}
		\begin{axis}[
  ...
  \addplot[Set1-A, very thick, dashed, samples=100] {100*(\x > 1.08)*(\x - 1.08) + 0.06};
\only<2->{
  \addplot[Set1-B, very thick, dashed] {-100*(\x > 1.12)*(\x - 1.12) - 0.03};
}
\only<2>{
  \addplot[Set1-C, very thick, samples=200] {-100*(\x > 1.12)*(\x - 1.12) - 0.03 + 100*(\x > 1.08)*(\x - 1.08) + 0.06};
}
\only<3->{
	\addplot[Set1-E, very thick, dashed, domain=1:1.12] {-0.06};
	\addplot[Set1-E, very thick, dashed, domain=1.12:1.16] {-4};
}
\only<3>{
	\addplot[Set1-C, very thick, domain=1:1.10, samples=200] {-100*(\x > 1.12)*(\x - 1.12) - 0.03 + 100*(\x > 1.08)*(\x - 1.08) + 0.06};
	\addplot[Set1-C, very thick, domain=1.12:1.16] {0.03};
}

  \draw[thick, color=black] (axis cs: 1, 0) -- (axis cs: 1.16, 0);
\end{axis}
\end{tikzpicture}
\end{frame}
...
\justify
1. Covered call: buy a stock market index, sell a call option at a high strike.

\justify
2. Short straddle: sell a straddle and delta-hedge it dynamically (later in this course).

\justify
3. Short OTM put: sell a put on a stock market index at a low strike (sell insurance against the market crash).
...
\justify
1. Sell (write) a 1 month at-the-money put option on S\&P\,500 index. E.g. sell at strike $K=\$5\,810$ in case current level is \$5\,810.
...
Geom. Mean & 9.5\% & 10.6\% & 2.9\% \\
Excess Return & 6.3\% & 7.4\% & 0.0\% \\
Std. Dev & 11.0\% & 16.0\% & 0.0\% \\
Share Ratio & 0.58 & 0.46 & 0.0 \\
Monthly Beta & 0.47 & 1.00 & 0.00
\end{tabular}

\small Sample period: 1987--2023. All figures except Beta are annualized.
