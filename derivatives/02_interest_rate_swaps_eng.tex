...
\justify
Suppose that we add a tiny interest to the deposit every hour, every minute, every seconds. Compounding frequency $f$ goes to infinity.
...
\justify
Consider deposits of 1\,000\,000 RUB each at the interest rate of 12\% with terms of 1 and 5 years. How does terminal amount on the account depend on compounding frequency?
...
\justify
Which method should you choose? Usually there is a market convention. Rule of thumb: ACT/365 in the British Commonwealth, ACT/360 is most other countries, BUS/252 in Brazil. 
\end{frame}
...
\item The size of interest rate payments does not fluctuate during the year
\end{itemize}
