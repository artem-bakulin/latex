...
\begin{align*}
\text{PV} = N - N\frac{S_0}{S} = N\frac{S - S_0}{S} = \EUR{1\,000\,000} \cdot \frac{83-82}{83} = \EUR{12\,048}
\end{align*}
...
\begin{axis}[
	...
	\drawVolNode{0.10}{0.180}{10P}{south west}
	\drawVolNode{0.25}{0.131}{25P}{south west}
	\drawVolNode{0.50}{0.100}{DN }{south}
	\drawVolNode{0.75}{0.131}{25C}{south east}
	\drawVolNode{0.90}{0.180}{10C}{south east}
\end{axis}
\end{tikzpicture}
\end{frame}
