...
\justify
1. Ожидаемая ставка краткосрочных депозитов в течение 10 лет.
...
\justify
Модель Adrian-Crump-Moench (ACM), облигации US Treasury, 1990--2025:
...
\justify
Модель Kim-Wright, облигации US Treasury, 1990--2025:
...
\centering
\begin{tabular}{l|r}
Срок (tenor)     & EURIBOR 06.03.2026 \\ \hline
1W (1 неделя)    & $1.898\%$ \\
1M (1 месяц)     & $1.940\%$ \\
3M (3 месяца)    & $2.049\%$ \\
6M (6 месяцев)   & $2.139\%$ \\
12M (12 месяцев) & $2.323\%$ 
\end{tabular}
...
\justify
В вычислении EURIBOR участвует 20 крупных банков Еврозоны. Каждый банк ежедневно отправляет свою ставку по каждому из пяти сроков (от недели до года). Банки обязаны следовать методологии, которая определяет 3 <<уровня>>:
...
\centering
\begin{tabular}{l|r}
Срок   & ESTER 05.03.2026 \\ \hline
1 день & $1.935\%$
\end{tabular}

\justify
В определении ESTER участвует панель из 49-ти банков. Каждый банк в течение дня сообщает ЕЦБ обо всех своих сделках (когда банк берёт кредит на 1 день). ЕЦБ отбрасывает 25\% самых маленьких и 25\% самых больших значений и вычисляет средневзвешенную ставку.
...
\begin{axis}[
  ...
  xtick={2020-01-01, 2021-01-01, 2022-01-01, 2023-01-01, 2024-01-01, 2025-01-01, 2026-01-01},
...
%  ylabel={\small{Курс USDRUB}},
  ...
  legend style={at={(0.03,0.97)},anchor=north west}
	...
	\draw[thick, color=black] (axis cs: 2012-01-01, 0) -- (axis cs: 2027-01-01, 0);
\end{axis}
\end{tikzpicture}
...
\justify
Биржа \en{ICE Futures Europe}\ (бывшая LIFFE) предлагает фьючерсы на трёхмесячный EURIBOR. Например, \alert{FEIM5} --- фьючерс на июнь 2026 года*.
...
2. 15 июня 2026 года** биржа установит финальную цену фьючерса $F = 100 - X$, где 
...
декабрь). 6 --- последняя цифра года.
...
\justify
Допустим, к 15 июня EURIBOR снизится до $1.5\%$.
...
\justify
Я заработал бы столько же, если бы EURIBOR был $2.30\%$:

$\EUR{1\,000\,000} \cdot 0.023/4 =\EUR{5\,750}$.
\end{frame}
...
\justify
Сколько рублей вы готовы заплатить сегодня (\en{PV}) за право получить 1\,200\,000 (\en{future value, FV}) рублей через год? Предположим, что на рынке есть идеальный безрисковый депозит под 20\% с простой капитализацией.

\begin{align*}
PV = \frac{FV}{1+rT} = \frac{1\,200\,000}{1 + 20\%} = 1\,000\,000
\end{align*}

\justify
Никто не захочет платить больше, чем 1\,000\,000 сегодняшних рублей за 1\,200\,000 будущих рублей, потому что выгоднее будет вложить 1\,000\,000 под 20\% на год. Никто не захочет продавать 1\,200\,000 будущих рублей дешевле, чем за 1\,000\,000 сегодняшних, потому что выгоднее будет взять в кредит 1\,000\,000 под 20\% и погасить его через год.
\end{frame}
...
\justify
Не так важно, ошибается ли рынок или нет, когда оценивает будущее значение $E_i$. Важно, что в нашем распоряжении есть ликвидные инструменты, которые позволяют захеджировать процентный риск и избавиться от всей неопределённости.

\justify
Допустим, мы должны будем заплатить кому-то за кредит по ставке $E_3$. Мы можем купить своп 9M и продать своп 6M. Тогда нам помогут заплатить $E_3$, а мы заплатим фиксированную ставку 4.00\% (мы продолжаем пренебрегать дисконтированием).

\centering
\begin{tabular}{l|r|r|r|r|r}
Дата    & \multicolumn{2}{c|}{Купить 9M} & \multicolumn{2}{c|}{Продать 6M}  & Итого \\ \hline
3M      & $-3.6\%$  &  $+3.0\%$  & $+3.4\%$ & $-3.0\%$ & $-0.2\%$ \\
6M      & $-3.6\%$  &      $+E_2$  &  $+3.4\%$ & $-E_2$ & $-0.2\%$ \\
9M      & $-3.6\%$  &      $+E_3$  &                      &              & $+E_3-3.6\%$
\end{tabular}

\justify
Мы можем купить себе $E_3$ за $4\%$ и жить в мире, в котором будущий EURIBOR всегда оказывается равен $4\%$.
\end{frame}
...
\begin{axis}[
  ...
  date coordinates in=x,
  date ZERO=2012-01-01,
  xtick={2025-01-01, 2026-01-01, 2027-01-01, 2028-01-01, 2029-01-01, 2030-01-01, 2031-01-01, 2032-01-01, 2033-01-01, 2034-01-01, 2035-01-01},
...
Effective date & 13.09.2027 & 13.09.2027 \\ 
Maturity date  & 12.03.2030 & 12.03.2030 \\
Notional       & \EUR{1\,000\,000} & \EUR{1\,000\,000} \\
Frquency       & Semi-annually     & Quarterly \\
Rate           & \alert{2.6278\%}          & EURIBOR-3M   \\
...
3M & $-16$ евро/б.п. & $+\EUR{634\,000}$ \\
1Y   & $-64$  евро/б.п. & $-\EUR{659\,000}$ \\
2Y    & $-196$ евро/б.п. & $+\EUR{1\,013\,000}$ \\
3Y    & $-113$ евро/б.п. & $+\EUR{394\,000}$ \\
4Y    & $-40$  евро/б.п. & $+\EUR{120\,000}$ \\
5Y    & $+463$ евро/б.п. & $-\EUR{994\,000}$ \\ 
7Y    & $0$ евро/б.п. & $\EUR{0}$ \\ 
10Y    & $0$ евро/б.п. & $\EUR{0}$ \\ \hline
Итого & $+163$ евро/б.п. & $+\EUR{507\,000}$
\end{tabular}
...
1. OIS свопы, чтобы вывести коэффициенты дисконтирования

2. Свопы и фьючерсы на 3M-EURIBOR, а также базисные свопы 3M-ESTER, чтобы вывести ожидаемые значения трёхмесячного EURIBOR.

3. Свопы на 6M-EURIBOR или базисные свопы 6M-3M, чтобы оценить будущие значения 6M-EURIBOR.
\end{frame}
