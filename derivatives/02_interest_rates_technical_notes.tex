...
Например, депозит на 1\,000\,000 под 12\% на 2 года с ежемесячной капитализацией:
\begin{align*}
1\,000\,000 \cdot \left(1 + \frac{0.12}{12}\right)^{12 \cdot 2} \approx 1\,269\,735
\end{align*}
\end{frame}
...
\justify
Сколько лет между 1 марта 2026 года и 1 апреля 2026 года?
...
\justify
Кредит на три месяца начался 31 марта 2026 года (вт). Когда он закончится: 30 июня (вт) или 1 июля (ср)?

\justify
Конвенция \en{modified following / business month end}:

\justify
1) Если дата начала --- последний рабочий день текущего месяца, то дата окончания --- тоже последний рабочий день месяца. Пример: 31.03.2026 (вт) --- 30.06.2026 (вт).
