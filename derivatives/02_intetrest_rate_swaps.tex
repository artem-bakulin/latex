...
\justify
1) Если дата начала --- последний рабочий день текущего месяца, то дата окончания --- тоже последний рабочий день месяца. Пример: 28.02.2022 (пн) --- 31.05.2022 (вт).
...
%  ylabel={\small{Курс USDRUB}},
  ...
  legend cell align={left}
	...
	\draw[thick, color=black] (axis cs: 2012-01-01, 0) -- (axis cs: 2023-01-01, 0);
\end{axis}
\end{tikzpicture}
...
\begin{axis}[
  ...
  date coordinates in=x,
  date ZERO=2012-01-01,
  xtick={2023-01-01, 2024-01-01, 2025-01-01, 2026-01-01, 2027-01-01, 2028-01-01, 2029-01-01},
  %minor xtick={2013-01-01, 2015-01-01, 2017-01-01, 2019-01-01, 2021-01-01},
  %ytick={-0.5, 0, 0.5, 1.0, 1.5},
  %minor ytick={-0.75, -0.25, 0.25, 0.75, 1.25},
  xticklabel={\year},
...
Maturity date  & 22-Mar-2027 & 23-Sep-2027 \\
