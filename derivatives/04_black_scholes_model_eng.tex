...
\justify
USDRUB options: expiration date 19.12.2024, data as of 04.11.2024.
...
\justify
S\&P\,500 options: expiration date 20.12.2024, as of 05.11.2024.
...
\begin{frame}{Butterflies: USDRUB}
\justify
...
\begin{frame}{Implied distribution: USDRUB}
\centering
\begin{tikzpicture}
\begin{axis}[
			width = \textwidth,
...
\begin{frame}{Butterflies: S\&P\,500}
\justify
S\&P\,500 butterflies at strikes $K-50$, $K$, $K+50$.
...
\justify
1. Market participants correctly anticipate higher probability of extreme outcomes.

\justify
2. Market participants are so scared of extreme outcomes that they are willing to pay for insurance. Risk-averse investors create additional demand for insurance and pull option premiums higher than the "fundamentally fair"\ level.
