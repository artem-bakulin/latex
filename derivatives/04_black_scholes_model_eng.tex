...
\justify
4. Ideal liquid market. No transaction costs, no arbitrage opportunities. We can delta-hedge as frequently as we'd like to.
\end{frame}
...
\begin{frame}{Historic volatility - 2}
\justify
...
\begin{frame}{Historic volatility - 3}
\centering
\begin{tikzpicture}
\begin{axis}[
  width=\textwidth,
...
\scriptsize Date: Central Bank of Russia.
\end{frame}
...
\begin{frame}{<<Ожидаемая>> волатильность}
\justify
Опционы на USDRUB с датой исполнения 15.06.2023.
...
\begin{frame}{<<Ожидаемая>> волатильность}
\justify
Опционы на S\&P\,500 с датой исполнения 16.06.2023.
...
\begin{frame}{Опционная бабочка}
\justify
Бабочки со страйками $K-1$, $K$ и $K+1$. Экспирация 15.06.2023.
