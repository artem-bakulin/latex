...
\begin{axis}[
	...
	date ZERO=2012-01-01,
  	xtick={2013-01-01, 2015-01-01, 2017-01-01, 2019-01-01, 2021-01-01, 2023-01-01, 2025-01-01,2027-01-01},
...
\addplot[color = Set1-B, mark = none, very thick]
   ...
   \draw[thick, color=black] (axis cs: 1985-01-01, 1) -- (axis cs: 2027-01-01, 1);
\end{axis}
\end{tikzpicture}
...
Геом. среднее & 10.1\% & 14.9\% & 1.6\% \\
Избыт. дох-ть & 8.3\% & 13.1\% & 0.0\% \\
Ст. откл. & 57.7\% & 14.6\% & 0.0\% \\
Отн. Шарпа & 0.14 & 0.89 & 0.0 \\
Мес. бета & 0.96& 1.00 & 0.00
\end{tabular}

\small{Период: 2013--2025. Все метрики, кроме беты, в годовом выражении.}
