...
\begin{tabular}{l|r|r|r|r|r|r|r}
                 & AAA       & AA         & A           & BBB        & BB & B &CCC \\ \hline
Среднее  &  0.17\% & 0.45\%  & 0.45\% & 0.84\% & 2.53\% & 2.09\% & 2.95\%  \\
Ст. откл. & 2.9\%    &3.0\%    & 4.2\%    & 5.4\%   & 7.6\%  & 9.7\%   & 15.0\%
\end{tabular}
}
\justify
\centering
{\scriptsize Избыточная доходность корпоративных облигаций сверх гос. 
облигаций, 1989--2020. Данные: \en{Ilmanen (2021)}.}
...
\justify
Котировки букмекеров на матч <<Бавария>> --- <<Реал>> в среду:
...
\justify
Допустим, что азартные болельщики поставили \$100 миллионов, из них 19.6 --- на ничью. При 
ничейном исходе победители заберут $\$19.6 \cdot 5.09 = \$100$ миллионов, то 
есть весь банк.
