...
- Быстродействие (450 тактов на Core i7-7700).
...
\justify
Для любой симметричной положительно определённой матрицы $Q$ существует разложение Холецкого (\en{Cholesky}) на нижнюю треугольную матрицу $L$ и верхнюю треугольную матрицу $L^T$:
\begin{align*}
Q = L \cdot L^T
\end{align*}
